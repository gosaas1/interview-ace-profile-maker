...
export function CreativePortfolioTemplate({ data }: CreativePortfolioTemplateProps) {
  const { personalInfo = {}, experience = [], education = [], skills = [], certifications = [], languages = [], references = [] } = data || {};
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 bg-white p-8 rounded shadow border max-w-4xl mx-auto font-[Nunito]">
      ...
      <div className="space-y-6">
        ...
        {skills.length > 0 && (
          <div>
            <div className="font-bold text-purple-600 mb-1 uppercase tracking-wide text-sm">Skills</div>
        ...
        {languages.length > 0 && (
          <div>
            <div className="font-bold text-purple-600 mb-1 uppercase tracking-wide text-sm">Languages</div>
        ...
        {certifications.length > 0 && (
          <div>
            <div className="font-bold text-purple-600 mb-1 uppercase tracking-wide text-sm">Certifications</div>
            <ul className="list-disc pl-5 text-xs text-gray-700">
      ...
      <div className="space-y-6">
        {experience.length > 0 && (
          <div>
            <div className="font-bold text-purple-600 mb-1 uppercase tracking-wide text-sm">Experience</div>
        ...
        {education.length > 0 && (
          <div>
            <div className="font-bold text-purple-600 mb-1 uppercase tracking-wide text-sm">Education</div>
            <ul className="list-disc pl-5 text-xs text-gray-700 space-y-2">
        ...
        {references.length > 0 && (
          <div>
            <div className="font-bold text-purple-600 mb-1 uppercase tracking-wide text-sm">References</div>
            <ul className="list-disc pl-5 text-xs text-gray-700">
