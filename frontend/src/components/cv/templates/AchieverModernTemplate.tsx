...
export function AchieverModernTemplate({ data }: { data: any }) {
  const { personalInfo = {}, experience = [], education = [], skills = [], certifications = [], languages = [], references = [] } = data || {};
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 bg-white p-8 rounded shadow border max-w-4xl mx-auto font-[Nunito_Sans]">
      ...
      <div className="space-y-6">
        ...
        <div>
          <div className="font-bold text-emerald-700 mb-1">Skills</div>
        ...
        <div>
          <div className="font-bold text-emerald-700 mb-1">Languages</div>
        ...
        <div>
          <div className="font-bold text-emerald-700 mb-1">Certifications</div>
          <ul className="list-disc pl-5 text-xs">
      ...
      <div className="space-y-6">
        <div>
          <div className="font-bold text-emerald-700 mb-1">Experience</div>
          <ul className="list-disc pl-5 text-xs">
        ...
        <div>
          <div className="font-bold text-emerald-700 mb-1">Education</div>
          <ul className="list-disc pl-5 text-xs">
        ...
        {references.length > 0 && (
          <div>
            <div className="font-bold text-emerald-700 mb-1">References</div>
            <ul className="list-disc pl-5 text-xs">
