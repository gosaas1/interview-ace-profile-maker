...
export function TechFocusedTemplate({ data }: { data: any }) {
  const { personalInfo = {}, experience = [], education = [], skills = [], certifications = [], languages = [], references = [] } = data || {};
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 bg-white p-8 rounded shadow border max-w-4xl mx-auto font-[Roboto_Mono]">
      ...
      <div className="space-y-6">
        ...
        <div>
          <div className="font-bold text-blue-700 mb-1">Skills</div>
        ...
        <div>
          <div className="font-bold text-blue-700 mb-1">Languages</div>
        ...
        <div>
          <div className="font-bold text-blue-700 mb-1">Certifications</div>
          <ul className="list-disc pl-5 text-xs">
