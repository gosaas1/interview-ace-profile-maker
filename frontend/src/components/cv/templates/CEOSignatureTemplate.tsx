...
export function CEOSignatureTemplate({ data }: { data: any }) {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 bg-white p-8 rounded shadow border max-w-4xl mx-auto font-serif">
      ...
      <div className="space-y-6">
        <div>
          <div className="text-2xl font-bold mb-1 text-slate-900">{personalInfo.fullName}</div>
        ...
        {skills.length > 0 && (
          <div>
            <div className="font-bold text-slate-700 mb-1 uppercase tracking-wide text-sm">Skills</div>
            <div className="flex flex-wrap gap-1 mb-2">
              {skills.map((skill: string, idx: number) => (
                <span key={idx} className="bg-slate-100 text-slate-800 px-2 py-1 rounded text-xs font-medium">{skill}</span>
              ))}
            </div>
          </div>
        )}
        {languages.length > 0 && (
          <div>
            <div className="font-bold text-slate-700 mb-1 uppercase tracking-wide text-sm">Languages</div>
        ...
        {certifications.length > 0 && (
          <div>
            <div className="font-bold text-slate-700 mb-1 uppercase tracking-wide text-sm">Certifications</div>
            <ul className="list-disc pl-5 text-xs text-gray-700">
      ...
      <div className="space-y-6">
        {experience.length > 0 && (
          <div>
            <div className="font-bold text-slate-700 mb-1 uppercase tracking-wide text-sm">Experience</div>
        ...
        {education.length > 0 && (
          <div>
            <div className="font-bold text-slate-700 mb-1 uppercase tracking-wide text-sm">Education</div>
            <ul className="list-disc pl-5 text-xs text-gray-700 space-y-2">
        ...
        {references.length > 0 && (
          <div>
            <div className="font-bold text-slate-700 mb-1 uppercase tracking-wide text-sm">References</div>
            <ul className="list-disc pl-5 text-xs text-gray-700">
