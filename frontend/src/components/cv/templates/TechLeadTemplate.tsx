...
export function TechLeadTemplate({ data }: { data: any }) {
  ...
  return (
    <div className="bg-white p-8 rounded shadow text-gray-900 max-w-2xl mx-auto space-y-6 font-[Roboto]">
      <div className="text-2xl font-bold mb-1 text-blue-900 text-left">{personalInfo.fullName}</div>
      <div className="text-sm mb-2 text-blue-700 text-left">{personalInfo.email}</div>
