      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature) => {
            ...
            return (
              <Card key={feature.id} className="rounded-2xl p-8 shadow-lg border border-slate-200 bg-white flex flex-col h-full justify-between transition-all duration-300">
