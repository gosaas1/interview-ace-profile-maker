...
export const STRIPE_PRICES = {
  ...
  starter: {
    monthly: 'price_1RezXMHO6B9cGpZ7TpRdpKJJ', // ✅ AUTOMATED - £11.99/month
    sixMonth: 'price_1RezXNHO6B9cGpZ74PzmgHUa', // ✅ AUTOMATED - £41.96 every 6 months (30% off)
    annual: 'price_1RezXNHO6B9cGpZ7LEd5MlmC', // ✅ AUTOMATED - £59.94/year (50% off)
  },
  
  professional: {
    monthly: 'price_1RezXNHO6B9cGpZ7vtNCzvEZ', // ✅ AUTOMATED - £17.99/month
    sixMonth: 'price_1RezXOHO6B9cGpZ7WgkVs8Yu', // ✅ AUTOMATED - £62.96 every 6 months (30% off)
    annual: 'price_1RezXOHO6B9cGpZ7AV6p7geH', // ✅ AUTOMATED - £89.94/year (50% off)
  },
  
  careerPro: {
    monthly: 'price_1RezXOHO6B9cGpZ7YBnDIXRe', // ✅ AUTOMATED - £35.99/month
    sixMonth: 'price_1RezXPHO6B9cGpZ7tkIz0dvR', // ✅ AUTOMATED - £125.96 every 6 months (30% off)
    annual: 'price_1RezXPHO6B9cGpZ7onGY5QtS', // ✅ AUTOMATED - £179.94/year (50% off)
  },
...
export const TIER_LIMITS = {
  free: { monthlyLimit: 1, features: ['basic_analysis'] },
  starter: { monthlyLimit: 5, features: ['detailed_analysis', 'cv_builder'] },
  professional: { monthlyLimit: -1, features: ['unlimited_analysis', 'gpt4_analysis', 'advanced_features'] },
  career_pro: { monthlyLimit: -1, features: ['all_professional', 'human_review', 'claude_analysis'] },
  elite_executive: { monthlyLimit: -1, features: ['all_career_pro', 'ai_coaching', 'premium_support'] }
} as const; 