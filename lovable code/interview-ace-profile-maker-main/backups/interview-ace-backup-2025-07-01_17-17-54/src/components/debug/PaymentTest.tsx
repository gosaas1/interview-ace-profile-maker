        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <div className="space-y-1 text-sm">
                <div><code className="bg-slate-100 px-2 py-1 rounded">4242 4242 4242 4242</code> - Visa</div>
                <div><code className="bg-slate-100 px-2 py-1 rounded">5555 5555 5555 4444</code> - Mastercard</div>
                <div><code className="bg-slate-100 px-2 py-1 rounded">4000 0082 6000 0000</code> - UK Visa</div>
              </div>
            </div>
            
            <div className="space-y-2">
              <h4 className="font-medium text-red-600">❌ Declined Payments</h4>
              <div className="space-y-1 text-sm">
                <div><code className="bg-slate-100 px-2 py-1 rounded">4000 0000 0000 0002</code> - Generic decline</div>
                <div><code className="bg-slate-100 px-2 py-1 rounded">4000 0000 0000 9995</code> - Insufficient funds</div>
                <div><code className="bg-slate-100 px-2 py-1 rounded">4000 0000 0000 9987</code> - Lost card</div>
              </div>
            </div>
          </div>
          ...
          <div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
            <p className="text-sm text-blue-700">
              💡 <strong>Tip:</strong> Use any future expiry date (e.g., 12/34) and any 3-digit CVC for testing
            </p>
          </div>
        </CardContent>
      </Card>
