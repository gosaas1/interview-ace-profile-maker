      ...
      if (uploadMethod === 'file' && uploadedFile) {
        ...
        try {
          ...
          cvData = {
            ...
            file_name: uploadedFile.name,
            file_size: uploadedFile.size,
            // Note: file_url will be null/undefined
          };
          
          // Show a warning toast but continue with save
          toast({
            title: "File Upload Warning",
            description: "CV will be saved but file upload failed. You can try uploading the file again later.",
            variant: "default",
          });
        }
