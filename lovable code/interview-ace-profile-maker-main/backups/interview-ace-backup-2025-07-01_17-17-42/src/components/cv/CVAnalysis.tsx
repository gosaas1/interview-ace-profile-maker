          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <Button 
                onClick={() => {
                  ...
                  toast({
                    ...
                    description: "Get started with our Starter plan for just £9.99/month!"
                  });
                }}
              ...
              >
                ...
                Start with Starter Plan - £9.99/month
                ...
                <Button 
                  onClick={() => {
                    ...
                    toast({
                      ...
                      description: "Unlimited analysis + advanced AI for £14.99/month"
                    });
                  }}
                ...
                <Button 
                  onClick={() => {
                    ...
                    toast({
                      ...
                      description: "Advanced AI coaching + human review for £29.99/month"
                    });
                  }}
