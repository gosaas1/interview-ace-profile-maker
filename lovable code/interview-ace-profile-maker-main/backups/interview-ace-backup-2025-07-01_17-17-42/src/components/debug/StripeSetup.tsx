        ...
        <Card className="mb-6">
          <CardHeader>
            <CardTitle className="flex items-center space-x-2">
              ...
              <span>Update src/lib/stripe.ts</span>
            </CardTitle>
            <CardDescription>
              Replace the STRIPE_PRICES object with your actual Price IDs
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              <div className="bg-slate-900 text-green-400 p-4 rounded-lg font-mono text-xs overflow-x-auto max-h-64">
              ...
              >
                <Copy className="h-4 w-4" />
                <span>Copy Stripe Configuration</span>
              </Button>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent>
            <div className="space-y-4">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <Button
                  variant="outline"
                  onClick={() => window.open('http://localhost:3000/debug/payments', '_blank')}
                >
                  Test Payment Lab
                </Button>
                <Button
